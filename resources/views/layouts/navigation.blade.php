        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <!-- (LOGO) Ruta que he creado en el archivo web.php y que llama a la funcion redirect de LoginController -->
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <!-- (LINK) Ruta que he creado en el archivo web.php y que llama a la funcion redirect de LoginController -->
                    <x-nav-link :href="route('products')" :active="request()->routeIs('products') || request()->is('/')">
                        {{ __('Products') }}
                    </x-nav-link>
                </div>
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('listadoPedidos')">
                                {{ __('Pedidos') }}
                            </x-dropdown-link>
