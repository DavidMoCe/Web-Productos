                                ...
                                <div id=titulo-botonCompra class="dark:text-white">
                                    ...
                                    <div class="actions mb-4 flex flex-row">
                                        ...
                                        <div class="buy-button mx-auto lg:!mx-0 md:mt-4">
                                            <button type="submit" class="px-20 py-3 md:px-40 lg:px-16 text-xl md:text-2xl bg-slate-900 dark:bg-slate-50 dark:hover:bg-slate-200 text-white dark:!text-neutral-800 rounded motion-safe:transition-colors motion-safe:duration-300 motion-safe:ease-out">
                                                Comprar
                                            </button>
                                        </div>
                                    </div>
