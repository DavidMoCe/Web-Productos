...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/profile', [ProfileController::class, 'updateShipping'])->name('profile.updateShipping');
    Route::post('/profile', [ProfileController::class, 'updateBilling'])->name('profile.updateBilling');
});
