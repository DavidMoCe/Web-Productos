...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/profile/{updateType}', [ProfileController::class, 'updateDirection'])->name('profile.updateDirection');
    // Route::match(['post'],'/profile', [ProfileController::class, 'updateBilling'])->name('profile.updateBilling');
});
